  ...
  const resumeData = {
    ...
    experience: {
      ...
      content: [
        ...
        {
          title: 'Co-Founder',
          company: 'UPlate Meal Planning',
          period: 'Aug 2025 – Present',
          bullets: [
            'Engineered a generative AI meal planning app using the Google Gemini API to synthesize personalized dietary schedules',
            'Integrated Purdue University dining hall data to generate location-specific, inventory-aware meal suggestions',
            'Built with Flutter, Firebase, and Vertex AI; Published on the iOS App Store',
          ],
        },
      ],
    },
